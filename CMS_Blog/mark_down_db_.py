...
def OpenColumn():
    ...
    def create_button_1():
     ...
     frame_open_2.grid(column=4,row=1,rowspan=2,padx= 5,pady=5)
     def Clicked(event):
...
def create_button_test():
    ...
    def Clicked(event):
      ...
      frame_open.place(relx=float(x/10),relheight=0.4, rely=float(y/10),relwidth=0.3)
    ...
    button_move1=Button(frame_box,text="↕️", fg="blue",font=("Arial",10,"normal"))  
    button_move1.grid(column=2,row=1)   
    button_move1.bind("<Button-1>",Clicked)
    button_move1=Button(frame_box,text="↔️", fg="blue",font=("Arial",10,"normal"))  
    button_move1.grid(column=2,row=4)   
    button_move1.bind("<Button-1>",Click_eo)
...
def OpenColumn3():
    ...
    Text_t3.place(relx=0.15,rely=0.3,relheight=0.5,relwidth=0.7 )
